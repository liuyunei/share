package com.szce.os.web.interceptor;
 ...
 */
public class OsWebInterceptor extends HandlerInterceptorAdapter {

    private static final Logger LOGGER = LoggerFactory.getLogger(OsWebInterceptor.class);
