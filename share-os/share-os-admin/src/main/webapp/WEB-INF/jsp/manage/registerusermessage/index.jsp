...
<script>
    ...
    $(function() {
        ...
        $table.bootstrapTable({
            url: '${basePath}/manage/registerusermessage/list',
            height: getHeight(),
            striped: true,
            search: true,
            showRefresh: true,
            ...
            columns: [
                ...
                {field: 'useraccount', title: '用户账号', sortable: true, align: 'center'},
                {field: 'idnumber', title: '身份证号'},
                {field: 'username', title: '用户名'},
                {field: 'userpassword', title: '用户密码'},
                {field: 'bankcard', title: '绑定银行卡号', align: 'center'},
                {field: 'alipay', title: '绑定支付宝号'},
                {field: 'wechat', title: '绑定微信号'},
