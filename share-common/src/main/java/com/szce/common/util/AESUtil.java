...
/**
 * AES加解密工具类
 * Created by szce on 2017/2/5.
 */
public class AESUtil {

    private static final String ENCODE_RULES = "SZCE";
...
//            throw new RuntimeException("兄弟，配置文件中的密码需要使用AES加密，请使用com.szce.common.util.AESUtil工具类修改这些值！");
            e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
