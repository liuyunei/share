...
<head>
	...
	<link href="${basePath}/resources/share-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/share-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/share-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/share-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/share-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/share-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; share-umps V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				<p><h4>深圳市互联网租赁自行车综合监管平台</h4></p>
				<p><b>平台简介</b>：本平台是基于网络的、多方参与的信息化综合监管平台，通过接入互联网租赁企业平台和各有关职能部门监管系统数据，搭建配套基础设施编码数据库，分类整合形成数据交换共享、车辆停放管理、基础设施管理、企业运营监管、骑行停放管理、骑行信息服务和决策支持七大系统，实现系统内部的数据交汇、查询统计、业务办理、信息传递、变更联动、监督考核等功能。提升对互联网租赁自行车行业监管及配套基础设施的信息统筹能力、协同工作效率和精细化管理水平，保障各职能部门工作的有序开展，促进互联网租赁自行车健康有序发展。</p>
				<p><b>系统简介</b>：本系统是基于RBAC授权和基于用户授权的细粒度权限控制通用平台，并提供单点登录、会话管理和日志管理。接入的系统可自由定义组织、角色、权限、资源等。</p><br/>
				<p><h4>系统功能概述：</h4></p>
				分类整合形成数据交换共享、车辆停放管理、基础设施管理、企业运营监管、骑行停放管理、骑行信息服务和决策支持七大系统
...
<script src="${basePath}/resources/share-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/share-admin/js/admin.js"></script>
<script src="${basePath}/resources/share-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/share-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>